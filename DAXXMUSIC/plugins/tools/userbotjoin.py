...
@app.on_message(filters.group & filters.command(["userbotjoin", "ujoin", f"userbotjoin@{app.username}"]) & ~filters.private)
...
@app.on_message(filters.command("userbotleave", "uleave") & filters.group & admin_filter)
